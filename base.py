...
#__________________________________________________________________________________________________________________________________
    ...
    #LIMPEZA DA PLANILHA:
       ...
       # Colunasplanilhaextratos= [""]
        ...
        self.base_rubricas.rename(columns={'cp_competencia': 'Data'}, inplace = True)
        self.base_rubricas.rename(columns={'cp3_nome_evento': 'Rubrica'}, inplace = True)
        self.base_rubricas.rename(columns={'cp3_valor_calc': 'Valor'}, inplace = True)
